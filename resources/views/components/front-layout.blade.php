...
<head>
    ...
    <meta property="og:title" content="Smart Student Shop" />
    <meta property="og:locale" content="en_US" />
    <meta name="theme-color" content="#f35627" />
    <link rel="canonical" href="https://smartstudentshop.com" />
    <meta property="og:url" content="https://smartstudentshop.com" />
    <meta name="description" content="We will make your life more stylish and comfortable" />
    <meta property="og:site_name" content="Smart Student Shop" />
    <meta property="og:image" content="https://smartstudentshop/assets/img/ban.png" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/styles/fonts.css') }}" media="screen" crossorigin="anonymous" />
    <link rel="stylesheet" href="{{ asset('/assets/styles/main.min.css') }}" media="screen" crossorigin="anonymous" />
    <!-- Facebook Pixel Code -->
    <script>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=458533281916325&ev=PageView&noscript=1" /></noscript>
    ...
    <div id="main">
            ...
            <div class="w-full sm:w-1/2 absolute left-0 top-0 px-6 py-6 z-10 bg-white shadow-sm rounded">
                <form class="border border-grey-dark px-4 py-3 rounded-md flex items-center">
                    <button class="flex items-center"><i
                            class="bx bx-search text-grey-darker text-xl pr-4 focus:outline-none"></i></button>
                        ...
                        <ul class="list-reset">
                            ...
                            <li class="pb-2 block">
                                <a href="https://elyssi.tailwindmade.com"
                                    class="font-hk text-white transition-colors hover:text-primary text-base tracking-wide">Smart
                                    Student Shop</a>
                            </li>
                        </ul>
                    </div>
                    <div class="text-center py-16 lg:py-0">
                        <a href="/" class="font-butler text-white text-4xl uppercase tracking-wider">Smart Student
                            Shop.</a>
        ...
        <div class="container py-8">
            <p class="font-hk text-secondary text-base text-center">
                All rights reserved © Smart Student Shop 2021 ❤️ 
