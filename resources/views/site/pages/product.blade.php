<x-front-layout>
    ...
    <div class="container">
                        ...
                        <div class="w-28 sm:w-32 lg:w-24 xl:w-28 relative pb-5 mr-3 sm:pr-0">
                            <div
                                ...
                                <img class="cursor-pointer object-cover" @click="selectedImage = $event.target.src"
                                    alt="product image" src="{{ $image->getFullUrl() }}" />
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="lg:w-1/2 pt-8 lg:pt-0 px-5">
                <div class="border-b border-grey-dark mb-8">
                    <div class="flex items-center">
                        ...
                        <p
                            ...
                            {{ $product->percent_discount }}% off</p>
                    </div>
                ...
                <form method="post" action="{{ route('cart.store') }}">
                        ...
                        @if ($attributeCheck)
                            ...
                            <div class="flex items-center justify-between pb-4">
                                ...
                                <div class="w-2/3 sm:w-5/6">
                                    <select class="w-2/3 form-select" name="{{ $attribute->name }}" required>
                    ...
                    <div class="flex items-center justify-between pb-8">
                        ...
                        <div class="w-2/3 sm:w-5/6 flex" x-data="{ productQuantity: 1 }">
                            <label for="quantity-form" class="block relative h-0 w-0 overflow-hidden">Quantity
                                form</label>
                            <input type="number" id="quantity-form" name="quantity"
                    ...
                    <div class="flex pb-8 group">
                        <button name="action" type="submit" value="add_to_cart" class="btn btn-outline mr-4 md:mr-6">Add
                            to cart</button>
                        <button name="action" type="submit" value="buy_now" class="btn btn-primary">ORDER NOW</button>
                    </div>
                    <div class="flex pb-2">
        ...
        <div class="pb-16 sm:pb-20 md:pb-24" x-data="{ activeTab: 'description' }">
            ...
            <div class="tab-content relative">
                ...
                <div :class="{ 'active': activeTab === 'reviews' }"
                    class="tab-pane bg-grey-light py-10 md:py-16 transition-opacity" role="tabpanel" id="review-tab">
                  ...
                  <i class="bx bxs-star text-primary"></i> -->
                            ...
                            <div class="flex justify-center sm:justify-start items-center pt-3">
                                ...
                                <p class="font-hk text-grey-darkest text-sm">{{ $review->created_at->diffForHumans() }}
                                </p>
                            </div>
                        </div>
                    @empty
                    ...
                    @auth
                        <form id="review" method="post" class="w-5/6 mx-auto">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-5 pt-10">
                                <div class="w-full">
                                    <label class="font-hk text-secondary text-sm block mb-2" for="review_title">Name</label>
                                    <input type="text" name="full_name"
                                        value="{{ auth()->check() ? auth()->user()->name : '' }}"
                                        placeholder="Enter your review title" class="form-input " id="review_title" />
                                </div>

                                <div class="w-full pt-10 sm:pt-0">
                                    <label class="font-hk text-secondary text-sm block mb-2">Rating</label>
                                    <fieldset class="rating">
                                        <input type="radio" id="star5" value="5" name="rating" /><label class="full"
                            ...
                            <div class="sm:w-12/25 pt-10">
                                <label for="message" class="font-hk text-secondary text-sm block mb-2">Review
                                    Message</label>
                                <textarea placeholder="Write your review here" name="message" class="form-textarea h-28"
                                    id="message"></textarea>
                            </div>
                    ...
                    @guest
                        <div class="w-5/6 mx-auto mt-3">
                            <p class="font-hk text-secondary">
                                ...
                                <a href="/login" class="font-hk text-primary">Log in to leave a review</a>
                            </p>
                        </div>
                    @endguest
                </div>
        ...
        @include('site.partials.related-products')
        <!-- Rlated Products  -->
    </div>
